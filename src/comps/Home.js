    ...
    <div className="home">
      <div className="bg">
        <div className="intro">
          ...
          <a href="#details-sec" className="scroll">
            {" "}
      ...
      <div id="details-sec" className="intro">
        ...
        <footer>
          <h3 id="icons-grid">
            <a href="https://www.linkedin.com/in/chandan-pk-510bb817a/">
              {" "}
              <span className="icons">
                <FaLinkedinIn />
              </span>{" "}
            </a>
            <a href="https://github.com/ChandanPk/isYourBirdayLucky">
              {" "}
              <span className="icons">
                <FaGithub />
              </span>{" "}
            </a>
            <a href="https://www.instagram.com/chandan_paull/">
              {" "}
              <span className="icons">
                {" "}
                <FaInstagram />
            ...
            <a href="https://chandankumar-portfolio.netlify.app/">
              {" "}
              <span className="icons">
                {" "}
                <FaBriefcase />
